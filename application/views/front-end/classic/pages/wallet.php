    ...
    <div class="main-content responsive-breadcrumb">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="#"><?= !empty($this->lang->line('wallet')) ? $this->lang->line('wallet') : 'Wallet' ?></a>
                </li>
            </ol>
        </nav>
    </div>
                                ...
                                <div class='card col-md-12'>
                                    <div class="row d-flex justify-content-center">
                                        <div class="h4 d-flex  mt-3  ">
                                            <img src="<?= THEME_ASSETS_URL . 'images/wallet.png' ?>"
                                                class="payment-gateway-images" alt="wallet"
                                        ...
                                        <div class="h4 d-flex justify-content-center  price">
                                            <p class="h4">
                                                <?= $settings['currency'] . ' ' . number_format($user->balance, 2) ?>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class='card-body bg-transparent'>
                                        ...
                                        <div class="h4 d-flex justify-content-center mt-2">
                                            <button type="button" class="button button-rounded button-primary"
                                                data-toggle="modal"
                                                data-target="#myModal"><?= label('add_money', 'Add money') ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class='card-body bg-transparent'>
                                        <div class="h4 d-flex justify-content-center mt-2">
                                            <button type="button" class="button button-rounded button-danger"
                                                data-toggle="modal"
                                                data-target="#withdraw"><?= label('withdraw_money', 'Withdraw Money') ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content card">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title price">
                                                <?= label('add_money_to_wallet', 'Add money to wallet') ?>
                                            </h4>
                                        </div>
                                        <!-- Modal body -->
                                        <div class="ship-details-wrapper mt-3 payment-methods">
                                            <form class="form-horizontal form-submit-event" method="POST"
                                                id="wallet_form" enctype="multipart/form-data">
                                                <?php
                                                ...
                                                <input type="hidden" id="user_contact"
                                                    value="<?= $username['mobile'] ?>" />
                                                <input type="hidden" name="logo" id="logo"
                                                    value="<?= base_url(get_settings('web_logo')) ?>" />


                                                <input type="hidden" name="order_id" id="order_id"
                                                    value="<?= $order_id ?>">
                                                <input type="number" name="amount" id="amount" min="1" required
                                                    class="col-md-11 ml-4 form-control" placeholder="Enter amount">


                                                <input type="text" name="message"
                                                    class="col-md-11 ml-4 mt-3 ticket_msg form-control "
                                                    id="message_input" placeholder="Type Message ...">
                                                <br>

                                                <div
                                                    class="align-item-center ship-title-details justify-content-between d-flex ml-3">
                                                    <h5><?= !empty($this->lang->line('payment_method')) ? $this->lang->line('payment_method') : 'Payment Method' ?>
                                                    </h5>
                                                </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php if (isset($payment_methods['phonepe_payment_method']) && $payment_methods['phonepe_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="phonepe">
                                                                            <input id="phonepe" name="payment_method"
                                                                                type="radio" value="phonepe" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="phonepe">
                                                                            <img src="<?= THEME_ASSETS_URL . 'images/phonepe.png' ?>"
                                                                                class="payment-gateway-images"
                                                                                alt="phonepe">
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                            ...
                                                            <?php if (isset($payment_methods['paypal_payment_method']) && $payment_methods['paypal_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="paypal">
                                                                            <input id="paypal" name="payment_method"
                                                                                type="radio" value="Paypal" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="paypal">
                                                            ...
                                                            <?php if (isset($payment_methods['razorpay_payment_method']) && $payment_methods['razorpay_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="razorpay">
                                                                            <input id="razorpay" name="payment_method"
                                                                                type="radio" value="Razorpay" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="razorpay">
                                                                    ...
                                                                    <td class="border-none">
                                                                        ...
                                                                        <input type="hidden" name="razorpay_order_id"
                                                                            id="razorpay_order_id" value="" />
                                                                        <input type="hidden" name="razorpay_payment_id"
                                                                            id="razorpay_payment_id" value="" />
                                                                        <input type="hidden" name="razorpay_signature"
                                                                            id="razorpay_signature" value="" />
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
                                                            <?php if (isset($payment_methods['paystack_payment_method']) && $payment_methods['paystack_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="paystack">
                                                                            <input id="paystack" name="payment_method"
                                                                                type="radio" value="Paystack" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="paystack">
                                                            ...
                                                            <?php if (isset($payment_methods['payumoney_payment_method']) && $payment_methods['payumoney_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="payumoney">
                                                                            <input id="payumoney" name="payment_method"
                                                                                type="radio" value="Payumoney" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="payumoney">
                                                                ...
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="flutterwave">
                                                                            <input id="flutterwave" name="payment_method"
                                                                                type="radio" value="Flutterwave" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="flutterwave">
                                                                    ...
                                                                    <td class="border-none">
                                                                        ...
                                                                        <?php foreach ($name as $username) { ?>
                                                                            <input type="hidden" name="flutterwave_public_key"
                                                                                id="flutterwave_public_key"
                                                                                value="<?= $payment_methods['flutterwave_public_key'] ?>" />
                                                                            <input type="hidden"
                                                                                name="flutterwave_transaction_id"
                                                                                id="flutterwave_transaction_id" value="" />
                                                                            <input type="hidden"
                                                                                name="flutterwave_transaction_ref"
                                                                                id="flutterwave_transaction_ref" value="" />
                                                                            <input type="hidden" name="promo_set" id="promo_set"
                                                                                value="" />
                                                                        <?php } ?>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <?php if (isset($payment_methods['paytm_payment_method']) && $payment_methods['paytm_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="paytm">
                                                                            <input id="paytm" name="payment_method"
                                                                                type="radio" value="Paytm" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="paytm">
                                                            ...
                                                            <?php if (isset($payment_methods['stripe_payment_method']) && $payment_methods['stripe_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="stripe">
                                                                            <input id="stripe" name="payment_method"
                                                                                type="radio" value="Stripe" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="stripe">
                                                                            <img src="<?= base_url('assets/front_end/modern/fontawesome-free-6.4.0-web/svgs/regular/credit-card.svg') ?>"
                                                                                class="payment-gateway-images" alt="Debit/Credit Card">
                                                                        </label>
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
                                                            ...
                                                            <?php if (isset($payment_methods['midtrans_payment_method']) && $payment_methods['midtrans_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="midtrans">
                                                                            <input id="midtrans" name="payment_method"
                                                                                type="radio" value="Midtrans" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="midtrans">
                                                                ...
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="my_fatoorah">
                                                                            <input id="my_fatoorah" name="payment_method"
                                                                                type="radio" value="my_fatoorah" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="my_fatoorah">
                                                                    ...
                                                                    <td class="border-none">
                                                                        <label for="instamojo">
                                                                            <img src="<?= THEME_ASSETS_URL . 'images/instamojo.png' ?>"
                                                                                class="payment-gateway-images height-30px"
                                                                                alt="instamojo">
                                                                        </label>
                                                                    </td>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" id="wallet_refill"
                                                        value="Save"><?= labels('Refill', 'Refill') ?></button>
                            ...
                            <div class="modal" id="withdraw">
                                <div class="modal-dialog">
                                    <div class="modal-content card">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title price">
                                                <?= label('withdraw_money', 'Withdraw Money') ?>
                                            </h4>
                                        </div>
                                        <!-- Modal body -->
                                        <div class="ship-details-wrapper mt-3 payment-methods">
                                            <input type="number" name="amount" id="withdrawal_amount" min="1" required
                                                class="col-md-11 ml-4 form-control" placeholder="withdrawal amount">
                                            ...
                                            <input type="text" name="payment_address" id="payment_address"
                                                class="col-md-11 ml-4 mt-3 ticket_msg form-control " id="message_input"
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" id="withdraw_amount"
                                                    value="Save"><?= labels('Withdraw', 'Withdraw') ?></button>
                                                <button type="button" class="btn btn-danger"
                                                    data-dismiss="modal">Close</button>
                                            </div>
                                        </div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab"
                                href="#wallet_transaction"><?= label('wallet_transaction', 'Wallet Transaction') ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab"
                                href="#withdrawal_requests"><?= label('wallet_requests', 'Wallet Requests') ?></a>
                        </li>
                    </ul>

                    <div class="tab-content">
                        <div id="wallet_transaction" class="tab-pane active"><br>
                            <table class="table-striped price" data-toggle="table"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="amount" data-sortable="false"><?= label('amount', 'Amount') ?>
                                        </th>
                                        <th data-field="status" data-sortable="false"><?= label('status', 'Status') ?>
                                        </th>
                        ...
                        <div id="withdrawal_requests" class="tab-pane fade"><br>
                            <table class='table-striped price' data-toggle="table"
                                data-url="<?= base_url('my-account/get_withdrawal_request') ?>"
                                data-click-to-select="true" data-side-pagination="server" data-pagination="true"
                                data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true"
                                data-show-refresh="true" data-trim-on-search="false" data-sort-name="oi.id"
                                data-sort-order="desc" data-mobile-responsive="true" data-toolbar=""
                                data-show-export="true" data-maintain-selected="true"
                                data-export-types='["txt","excel","csv"]'
                                data-export-options='{"fileName": "order-item-list","ignoreColumn": ["state"] }'
                                data-query-params="customer_withdrawal_query_params">
                                <thead>
                                    <tr>
...
<?php if ($this->session->flashdata('message')) { ?>
    <script>
        (function () {
            var icon = '<?= $this->session->flashdata('message_type'); ?>';
            var title = "<?= addslashes($this->session->flashdata('message')); ?>";
