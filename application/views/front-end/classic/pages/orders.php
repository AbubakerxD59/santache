                                ...
                                <div class="card-body p-2">
                                    <div class="media flex-column flex-sm-row">
                                        <div class="media-body ">
                                            ...
                                            <?php } ?>
                                            <?php $payment_method_label = ($row['payment_method'] == 'Stripe') ? 'Debit/Credit Card' : $row['payment_method']; ?>
                                            <h4 class="mt-3 mb-4 bold"> <span class="mt-5"><i><?= $settings['currency'] ?></i></span> <?= number_format($row['final_total'], 2) ?> <span class="small text-muted"> <?= !empty($this->lang->line('via')) ? $this->lang->line('via') : 'via' ?> (<?= $payment_method_label ?>) </span></h4>
